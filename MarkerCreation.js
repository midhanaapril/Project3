...
var layers = {
  MEMBERSHIP_TYPE1: new L.LayerGroup(),
  MEMBERSHIP_TYPE2: new L.LayerGroup(),
  MEMBERSHIP_TYPE3: new L.LayerGroup()
};

// Create the map with our layers.
var map = L.map("map-id", {
  center: [32.1656, -82.9001], // coordinates to Georgia
  zoom: 12,
  layers: [
    layers.MEMBERSHIP_TYPE1,
    layers.MEMBERSHIP_TYPE2,
    layers.MEMBERSHIP_TYPE3
  ]
});
...
var overlays = {
  "MEMBERSHIP_TYPE1": layers.MEMBERSHIP_TYPE1,
  "MEMBERSHIP_TYPE2": layers.MEMBERSHIP_TYPE2,
  "MEMBERSHIP_TYPE3": layers.MEMBERSHIP_TYPE3
};
...
var icons = {
  MEMBERSHIP_TYPE1: L.ExtraMarkers.icon({
    icon: "ion-settings",
    iconColor: "white",
    markerColor: "yellow",
    shape: "star"
  }),
  MEMBERSHIP_TYPE2: L.ExtraMarkers.icon({
    icon: "ion-android-bicycle",
    iconColor: "white",
    markerColor: "red",
    shape: "circle"
  }),
  MEMBERSHIP_TYPE3: L.ExtraMarkers.icon({
    icon: "ion-android-bicycle",
    iconColor: "white",
    markerColor: "orange",
    shape: "circle"
